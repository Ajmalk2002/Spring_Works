...
public class WrapperCls {
	...
	public static void main(String[] args) {
		...
		Integer a1 = new Integer(15); // Wrapper object created ✓
		int i12 = a1; // UNBOXING: Integer → int ✓
		int y = 900;
		Integer yObj = y; // AUTOBOXING: int → Integer ✓

		System.out.println("a value : " + a1); // 15
		System.out.println(a1.getClass().getName()); // java.lang.Integer
		System.out.println("y datatype (boxed): " + yObj.getClass().getName()); // java.lang.Integer
		System.out.println("I value : " + i12); // 15

		System.out.println(((Object) i12).getClass().getName()); // java.lang.Integer (autoboxed!)
